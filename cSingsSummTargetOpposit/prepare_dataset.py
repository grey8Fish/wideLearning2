...
if __name__ == "__main__":
    file_name = "loan_sanction_test.csv"     # Имя файла (с расширением)
    class_column = "Property_Area"            # Целевая колонка
    instance_column = "Loan_ID"            # ID колонка, любой итератор (если есть). Если нет - комментируем всю строчку или оставляем пустой.
    significant_digits = 1              # Максимальное количество значащих цифр перед округлением. Можно закомментировать, будет использоваться максимальное по датасету.
