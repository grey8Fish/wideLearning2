...
if __name__ == "__main__":
    file_name = "bodyPerformance.csv"     # Имя файла (с расширением)
    class_column = "class"            # Целевая колонка
    ...
    max_rows_per_class = 400           # Устанавливаем ограничение количества строк в одном классе. Можно закомментировать, опционально.
